...
class Matrix5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.matrix5x5)
        ...
        val gridLayout: GridLayout = findViewById(R.id.matrixGridLayout5x5)

        // Initialize the 3x3 matrix of buttons and matrix values
        matrixButtons = Array(5) { i ->
            Array(5) { j ->
                createMatrixButton(i, j)
            }
        }
        matrix = Array(5) { Array(5) { 'A' } }
